...
import static com.zandero.rest.data.ClassUtils.checkIfCompatibleType;
import static com.zandero.rest.data.ClassUtils.stringToPrimitiveType;

public class SkipNullBeanProvider implements BeanProvider {
