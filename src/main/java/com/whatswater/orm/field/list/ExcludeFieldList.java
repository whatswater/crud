...
public class ExcludeFieldList implements FieldList {
    ...
    public ExcludeFieldList(FieldList baseProperties) {
        this.baseProperties = baseProperties;
    }

    public ExcludeFieldList(FieldList baseProperties, Set<String> excludePropertyNames) {
        this.baseProperties = baseProperties;
